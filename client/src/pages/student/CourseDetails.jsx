...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    text-course-deatails-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          ...
          <div className='flex items-center space-x-2 pt-2 pb-3 text-sm'>
            ...
            <p className='text-gray-500'>{courseData.courseRatings.length} {courseData.
              courseRatings.length > 1 ? 'ratings' : 'rating'}</p>
            <p>{courseData.enrolledStudents.length}{courseData.enrolledStudents
              .length > 1 ? ' students' : ' student'}</p>
          </div>
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Shubhankar</span></p>
        ...
        bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
             ...
             <div className='flex gap-3 items-center pt-2'>
              ...
              <p className='md:tetxt-lg text-gray-500  line-through'>
             ...
             <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white
               ...
               <div className='pt-6'>
                ...
                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                  <li>Lifetime acces with free</li>
                  <li>Step by step hands on project</li>
                  <li>Downloadable resourse</li>
                  <li>Quizzes tto learn</li>
                  <li>Certificatiion of completion</li>
                </ul>
               </div>
