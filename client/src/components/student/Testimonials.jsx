...
const Testimonials = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Learn from our learners as they share their journeys of  transformation,succes and how our <br />platform has mafe a difference in their lives</p>
